...
function MainMenu(){
    return <div id="main-menu">
               ...
               <main>
                    ...
                    <Button onClick={()=>route("/game",{ query: {saved: true, mp: false}})} type="primary">{startmenu.resume_game}</Button> 
                    <Button onClick={()=>route("/game",{ query: {
                         mp: false,
                         saved: false, 
                         opp: 1, 
                         players:["Imperius_8798531543"]}})} type="primary">DEV START</Button> 
